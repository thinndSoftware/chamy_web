...
class IntagramController extends Controller
{
    ...
    public function __construct(intagrams $sliders)
    {
    ...
    public function index()
    {
        ...
        return view('admin.intagrams.slider', compact('sliders'));
    }

    public function create()
    {
        return view('admin.intagrams.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.intagrams.edit', compact('sliders'));
    }
