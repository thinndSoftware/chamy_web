...
//Sản phẩm
Route::get('/productSixdo',[HomeController::class,'productSixdo'])->name('productSixdo');
//Sản phẩm sale
Route::get('/productSixdoSale',[HomeController::class,'productSixdoSale'])->name('productSixdoSale');
//Bộ sưu tập 
Route::get('/productSixdoBST',[HomeController::class,'productSixdoBST'])->name('productSixdoBST');
//thông tin cửa hàng
Route::get('/inforShopChamy',[HomeController::class,'inforShopChamy'])->name('inforShopChamy');
//chi tiết sản phẩm
Route::get('/productSixdoDetail',[HomeController::class,'productSixdoDetail'])->name('productSixdoDetail');
...
Route::prefix('/admin')->group(function () {
    ...
    Route::prefix('/intagrams')->group(function () {
        Route::get('/', [IntagramController::class, 'index'])->name('intagrams.slider');
        Route::get('/create', [IntagramController::class, 'create'])->name('intagrams.create');
        Route::post('/strore', [IntagramController::class, 'store'])->name('intagrams.strore');
